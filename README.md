...
*Note: Please ensure the diagram is uploaded to the `/docs` folder.*
...
## 🚀 Core Features
* **Intelligent Reasoning:** Uses LLM (GPT/Llama) to parse non-standard commands (e.g., "I'm finished with this" → `PLACE` command).
